...
import 'package:happy_tails/data/wishlist_data.dart';
...
class _ShopProductCardState extends State<ShopProductCard> {
  ...
  void initState() {
    super.initState();
    isFavorite = wishListItems.any((item) => item.name == widget.product.name);
  }
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
                        ...
                        if (isFavorite) {
                          bool exists = wishListItems.any((item) => item.name == widget.product.name);
                          if (!exists) {
                            wishListItems.add(
                              WishlistItem(
                          ...
                          wishListItems.removeWhere((item) => item.name == widget.product.name);
                        }
                      });
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        // সরাসরি গ্লোবাল লিস্টে অ্যাড করা হচ্ছে
